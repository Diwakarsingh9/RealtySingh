...
import com.Apporio.realtysingh.RealtyTrendsfragment;
import com.squareup.picasso.Picasso;


public class Realtytrendsadapter extends BaseAdapter {
...
//            R.drawable.bgg,R.drawable.flip1,R.drawable.reall2,R.drawable.flip2,R.drawable.flip3,};
    ...
    public Realtytrendsadapter(Context activity, ArrayList<String> stringArrayList, ArrayList<String> strings, ArrayList<String> moduletilte, ArrayList<String> moduledate, ArrayList<String> moduledescp, ArrayList<String> moduleimg, ArrayList<String> image1, ArrayList<String> title1, ArrayList<String> modulesrc_link) {
            ...
            if(position<6) {
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        in.putExtra("title", "Realty Trends");
                        ...
                        in.putExtra("id", RealtyTrendsfragment.module_id.get(pos));
