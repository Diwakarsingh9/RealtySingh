...
import com.Apporio.realtysingh.Blogfragment;
...
public class Blogadapter extends BaseAdapter {
    ...
    public Blogadapter(Context activity, ArrayList<String> stringArrayList, ArrayList<String> strings, ArrayList<String> moduletilte, ArrayList<String> moduledate, ArrayList<String> moduledescp, ArrayList<String> moduleimg, ArrayList<String> modulesrc_link) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.blogitem, null);
        holder = new Holder();
       ...
       // holder.descp.setText("" + Html.fromHtml("" + dscvp.get(position)).toString());
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra("id", Blogfragment.module_id.get(pos));
