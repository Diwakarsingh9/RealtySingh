...
import com.Apporio.realtysingh.Videofragment;
...
public class Videoadapter extends BaseAdapter {
    ...
    public  static ArrayList<String> module_key;
    ...
    public Videoadapter(Context activity, ArrayList<String> stringArrayList, ArrayList<String> strings, ArrayList<String> moduletilte, ArrayList<String> moduledate, ArrayList<String> moduledescp, ArrayList<String> moduleimg, ArrayList<String> modulekey, ArrayList<String> modulesrc_link) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.videoitem, null);
        holder = new Holder();
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(ctc2, Videoactivity.class);
                ...
                in.putExtra("key",module_key.get(pos));
                in.putExtra("src_link",src_link.get(pos));
                in.putExtra("id", Videofragment.module_id.get(pos));
