...
import com.Apporio.realtysingh.Try;
                      ...
                      //Toast.makeText(activity, ""+Mainfragment.viewPager.getCurrentItem(), Toast.LENGTH_SHORT).show();
                        for (int i = 0; i < 3; i++) {
                            if (data_list1.size() > 3) {
                                Videoactivity.relatedsearch.setVisibility(View.VISIBLE);
                                Videoactivity.v111.setVisibility(View.VISIBLE);
                                Videoactivity.llforrecnt.setVisibility(View.VISIBLE);
                                Videoactivity.llforlist.addView(ordersview(R.layout.itemforrecent, i));
                            }
                            else {
                                Videoactivity.llforrecnt.setVisibility(View.GONE);
                                Videoactivity.relatedsearch.setVisibility(View.GONE);
                                Videoactivity.v111.setVisibility(View.GONE);
                            }
                        }
    ...
    public static View ordersview(int layout_name, int i) {
        ...
        addView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(Videoactivity.lis,Try.class);
                ...
                in.putExtra("key", modulekey.get(position));
